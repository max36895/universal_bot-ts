...
//     REQ запросов, пока медиана последних двух циклов не перестанет
...
const { markRow } = require('./markRow');

const ROUNDS = 10;
// Прогрев до плато: циклами по REQ запросов, максимум 20 циклов.
...
/**
 * Прогрев до плато: циклы по всему набору запросов раунда (REQ), пока медиана последних
