...
- Вся работа с платформами настраивается через адаптеры. Подробнее о переводе на новое
  API смотрите [тут](/src/docs/next-releace.md)
- Работа с базами данных настраивается через адаптеры. Подробнее о переводе на новое API
  смотрите [тут](/src/docs/next-releace.md)
- Поменялось API для основных классов. Подробнее о переводе на новое API смотрите [тут](/src/docs/next-releace.md)
...
- Произведена внутренняя оптимизация логики фреймворка, благодаря чему удалось получить увеличение производительности
  ...
  на 10-20% для текстовых команд и на 10-18% для регулярных выражений. Потребление памяти уменьшилось на 12-18%.
