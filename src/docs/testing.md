...
Перейти в [консоль разработчика](https://dialogs.yandex.ru/developer) и открыть вкладку тестирования.
Это актуально для Алисы. Для других платформ ссылка вставляется в соответствующую консоль разработчика.
