...
7. ~~Оптимизация поиска команд по регулярным выражениям — исследуем возможность ускорения матчинга. Результаты повлияют
   на финальный набор фич в 3.0.~~
...
| Оптимизация поиска по regex    | не делается | Остается текущая реализация работы с регулярными выражениями. При необходимости проблема будет решаться разработчиками по месту. |
