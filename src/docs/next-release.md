...
6. **Обновление зависимостей** — минимальная версия Node.js стала 20. У версии 18 закончилась официальная поддержка.
7. **Оптимизация поиска по regex** — не реализована. Остается текущая реализация. При необходимости проблема решается разработчиками по месту.
