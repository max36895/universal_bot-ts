...
**Ответ**: `umbot` — это мультиплатформенный фреймворк на TypeScript, который позволяет писать логику один раз и запускать её на 7+ платформах: Алиса, Маруся, Сбер, Telegram, VK, Viber, MAX.
