...
Смотри раздел: [Универсальный webhook-обработчик](https://www.maxim-m.ru/bot/ts-doc/documents/umbot_v-3.0_.src_docs_platform-integration#🌐-универсальный-webhook-обработчик) в руководстве по платформам.
