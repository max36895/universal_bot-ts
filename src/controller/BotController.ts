...
/**
 * Контроллер приложения – главный класс для реализации логики навыков Алисы, Telegram‑ботов и других платформ.
 *
 ...
 * @see Bot – основной класс бота, управляющий адаптерами и контроллерами.
 */
...
> {
    ...
    /**
     * Основной метод, в котором вы реализуете логику вашего навыка или бота.
     *
