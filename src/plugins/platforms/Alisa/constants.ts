 ...
 *
 * Документация Яндекса противоречит сама себе: спецификация карточки
 * (response-card-imagegallery) дважды указывает «от 1 до 10», а обзорная
 * страница формата ответа (response) — «от 1 до 7». Берём детальную
 * спецификацию как первоисточник; если платформа начнёт отклонять галереи
 * из 8–10 изображений — снизить значение до 7.
 */
