...
| 2.1.x  | ❌ Не поддерживается | 31.03.2026 (содержит критические архитектурные проблемы) |
...
> Также убедитесь, что ваша среда использует поддерживаемую версию NodeJS 20+ (версия 18 и ниже не поддерживается
> официально).
...
3. **Предложить исправление (Pull Request)**
    ...
    - Мы рассматриваем все входящие PR в течение 1-2 рабочих дней. При отсутствии критических замечаний исправление
      будет принято и включено в ближайший релиз.
...
4. При возможности, предложите реализацию или своё видение решения
